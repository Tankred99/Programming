...
public class App extends TelegramLongPollingBot {
    ...
    private String sendToLMStudio(String prompt, String model) {
        ...
        try {
            // Create HTTP client with timeout and debug redirects
            ...
            requestJson.put("max_tokens", 40000); // Set a specific max tokens value
            ...
            // Add messages array to main JSON
            requestJson.put("messages", messagesArray);

            String requestBody = requestJson.toString();
            printLog(
                "REQUEST BODY",
                "Length: " + requestBody.length() + " chars",
                "Content: " +
            ...
            // Create HTTP request with explicit POST method
            printLog(
                "HTTP REQUEST",
                "URL: " + LM_STUDIO_API_URL,
                "Method: POST"
            );
            ...
            printLog(
                ...
                "Headers: " + request.headers().map().toString()
            );
            ...
            try {
                ...
                // Limit the response log size if it's too large
                String responseBody = response.body();
                String logResponseBody = responseBody.length() > 300
                ...
                if (statusCode == 200) {
                    ...
                    String errorMessage =
                        "HTTP " + statusCode + ": " + logResponseBody;
                    ...
                    return (
                        "Sorry, I encountered an error when processing your request. Error code: " +
                        statusCode
                    );
                }
            } catch (IOException e) {
